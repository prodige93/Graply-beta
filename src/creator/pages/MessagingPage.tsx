...
const mockConversations: Conversation[] = [
  ...
  },
  {
    ...
    verified: true,
    lastMessage: 'Merci pour le retour, je corrige ça',
    time: 'Hier',
    unread: 0,
    online: false,
    platform: 'youtube',
  },
  {
    ...
    verified: false,
    lastMessage: 'La vidéo est prête, je l\'envoie ce soir',
    time: 'Hier',
    unread: 0,
    online: false,
    platform: 'tiktok',
...
export default function MessagingPage() {
  ...
  const fromProfile = !!(dmParam && location.key !== 'default');
  ...
  return (
    <div className="h-screen text-white flex overflow-hidden" style={{ backgroundColor: '#050404' }}>
      ...
      <div className="hidden lg:flex px-6 lg:px-8 pt-8 pb-6 items-center gap-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div>
          <h1 className="text-xl lg:text-2xl font-bold text-white">Messagerie</h1>
          <p className="text-sm text-white/40 mt-0.5">Vos conversations</p>
        </div>
      </div>

      <div
        className={`lg:hidden px-4 pt-8 pb-6 items-center gap-4 ${activeConversation ? 'hidden' : 'flex'}`}
        style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}
      >
        {fromProfile && (
          <button
            onClick={() => fromSearch ? navigate('/recherche') : navigate(-1)}
      ...
      <div className="flex flex-1 overflow-hidden">
        <div
          className={`w-full lg:w-80 shrink-0 flex flex-col overflow-hidden ${activeConversation ? 'hidden lg:flex' : 'flex'}`}
                ...
                <div className="flex-1 min-w-0 text-left">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5 min-w-0">
                      ...
                      {conv.verified && <img src={verifiedIcon} alt="" className="w-5 h-5 shrink-0" />}
                    </div>
        ...
        <div className={`flex-1 flex flex-col min-h-0 pb-20 lg:pb-0 ${!activeConversation ? 'hidden lg:flex' : 'flex'}`}>
          {currentConversation ? (
            <>
              <div
              ...
              >
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => fromProfile ? (fromSearch ? navigate('/recherche') : navigate(-1)) : setActiveConversation(null)}
                ...
                >
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      {currentConversation.verified && <img src={verifiedIcon} alt="" className="w-[23px] h-[23px]" />}
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-white/30 font-medium">Sélectionnez une conversation</p>
                <p className="text-xs text-white/15 mt-1">Choisissez un créateur pour commencer</p>
              </div>
            </div>
          )}
        </div>
