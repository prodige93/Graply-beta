...
export default function MessagingPage() {
  ...
  return (
    <div className="h-screen text-white flex overflow-hidden" style={{ backgroundColor: '#050404' }}>
      ...
      <div className="hidden lg:flex px-6 py-4 items-center gap-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        {fromProfile && (
          <button
            onClick={() => fromSearch ? navigate(ROUTES.rechercheCreateurs) : navigate(-1)}
            ...
            <>
              ...
              >
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => fromProfile ? (fromSearch ? navigate(ROUTES.rechercheCreateurs) : navigate(-1)) : setActiveConversation(null)}
