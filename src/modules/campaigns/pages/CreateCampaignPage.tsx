...
import StepOne from '@/modules/campaigns/ui/create-campaign/StepOne';
import StepTwo from '@/modules/campaigns/ui/create-campaign/StepTwo';
import StepThree from '@/modules/campaigns/ui/create-campaign/StepThree';
import StepFour from '@/modules/campaigns/ui/create-campaign/StepFour';
import StepFive from '@/modules/campaigns/ui/create-campaign/StepFive';
import CampaignPreview from '@/modules/campaigns/ui/create-campaign/CampaignPreview';
...
export default function CreateCampaignPage() {
  ...
  const handlePublish = async () => {
    ...
    setPublishing(true);
    try {
      const photoUrl = photo ? await fileToDataUrl(photo) : (isEditMode ? photoPreview : null);
      const payload = {
        name,
        description,
        photo_url: photoUrl,
