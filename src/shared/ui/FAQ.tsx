...
const faqs = [
  {
    question: 'Comment fonctionne Content Rewards ?',
    answer:
      'Content Rewards met en relation des marques avec des createurs de contenu. Tu choisis une campagne, tu crees du contenu video court, et tu es paye en fonction de tes performances. Pas besoin d\'audience massive — juste de la creativite et de la regularite.',
  },
  {
