...
export default function Hero({ isMars, onToggle, onAuthClick }: HeroProps) {
  const handleCountryClick = useCallback(() => {
    scrollToElement('how-it-works');
  }, []);

  return (
    <section className="relative bg-black overflow-hidden px-6 pt-20 md:pt-28 pb-0">
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center">
        ...
        <div className="relative mt-10 md:mt-14 w-full flex flex-col items-center justify-center">
          ...
          <div className="mt-16 sm:mt-20 md:mt-24 lg:mt-28 z-20">
            <HeroCTAs isMars={isMars} onAuthClick={onAuthClick} />
          </div>
        </div>
